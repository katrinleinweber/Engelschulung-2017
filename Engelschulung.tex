...
\item [(* ] mixer angel checks slides) % if you still have time and if the speaker looks like they have camacity for it, the mixer angel takes a look at the slides to figure out whether or not to use picture-in-picture or superscource in this talk
\end{itemize} 
\end{frame}
