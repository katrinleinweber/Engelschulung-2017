...
\item check in with angels, in case of non-appearing angel, call \textbf{1607} or \textbf{1023} % meet at the mixer desk, is everybody there? if yes camera angels go to cameras and everybody starts using intercom, if not camm heaven für replacement  
